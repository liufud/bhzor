...
<%-- 				</sec:authorize>
        ...
        <div class="row">
            <div class="col-xs-12">
                <h4><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Conectado como : <sec:authentication property="name"/> <sec:authentication property="authorities"/></h4>
            </div>
        </div>            
        <div class="row">
            <div class="col-xs-12">
                    ...
                    <div class="caption">
                        ...
                        <sec:authorize access="hasAuthority('Administrador')">
                            <p class="text-justified">Esta aplicación web es un control de inventario multi-usuario. No solo ayuda a administradores en manejar el inventario y hacer pedidos 
                                de producto, también permite a diferentes usuarios (clientes, vendedores o distribuidores) en hacer pedidos para diferentes productos. </p>	           
                        </sec:authorize>
                        ...
                        <p class="text-center">
                            ...
                            <a class="btn btn-default" role="button" href="<c:url value="/perform_logout" />">Cerrar Sesión</a>
                        </p>
                    </div>
                </div>
            </div>
